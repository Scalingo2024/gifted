...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~GmIkHAia#CA85xGxY9ys60zunl4scuFDi2b1mgPlH0E6kEE8SzOE", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "94713520744", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94711814650", // Only 1 owner Number Here, others Add to sudo numbers...
